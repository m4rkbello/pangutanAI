      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
          {features.map((feature, index) => (
            <Card key={index} className="relative p-4 sm:p-6 bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl hover:border-neon-blue/30 hover:shadow-[0_8px_40px_rgba(0,243,255,0.1)] transition-all duration-500 group overflow-hidden">
              ...
              <h3 className="text-base sm:text-lg lg:text-xl font-semibold mb-2 text-white group-hover:text-neon-blue transition-colors duration-300">
                {feature.title}
              </h3>
              ...
              <span className="text-xs sm:text-sm text-neon-blue/70 group-hover:text-neon-pink transition-colors duration-300 font-medium">
                {feature.highlight}
              </span>
            </Card>
          ))}
