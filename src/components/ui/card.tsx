...
function CardContent({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("px-4 group-data-[size=sm]/card:px-3 text-white/80", className)}
      {...props}
    />
  )
}
...
function CardFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex items-center rounded-b-xl border-t border-white/10 bg-white/5 backdrop-blur-sm p-4 group-data-[size=sm]/card:p-3",
        className
      )}
      {...props}
    />
