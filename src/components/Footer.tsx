        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#features" className="text-white/60 hover:text-neon-blue transition-colors">Features</a></li>
              <li><a href="#demo" className="text-white/60 hover:text-neon-blue transition-colors">Demo</a></li>
              <li><a href="#api" className="text-white/60 hover:text-neon-blue transition-colors">API</a></li>
              <li><a href="#docs" className="text-white/60 hover:text-neon-blue transition-colors">Documentation</a></li>
            </ul>
          </div>
          <div>
